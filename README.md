...
- [Maven](https://s01.oss.sonatype.org/content/repositories/snapshots/com/github/kepocnhh/NFCTags/0.2.0u-SNAPSHOT)
...
dependencies {
    implementation("com.github.kepocnhh:NFCTags:0.2.0u-SNAPSHOT")
}
```
